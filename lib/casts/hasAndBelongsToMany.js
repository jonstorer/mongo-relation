...
function HasAndBelongsToManyGetter (val, schemaType){
  return val;
};

HasAndBelongsToManyGetter.prototype.build = function (object) {
};
...
module.exports = function (schema, childAssociationName, options) {
  ...
  //var get = new HasAndBelongsToMany(this, options);
