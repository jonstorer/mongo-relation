...
Schema.prototype._addRelationship = function (type, model, options) {
  ...
  this.paths[pathName].options.setParent = options && options.hasOwnProperty('setParent') ? options.setParent : true;
  return this;
};
/**
...
MongooseArray.prototype.build = function (objs) {
  ...
  var self = this, parent = this._parent, childModelName = this._schema.options.hasMany || this._schema.options.habtm, setParent = this._schema.options.setParent; childModel = parent.model(childModelName), childSchema = childModel.schema, parentModelName = parent.constructor.modelName, childPath = childSchema._findPathReferencing(parentModelName);
...
MongooseArray.prototype.find = function (conditions, fields, options, callback) {
  ...
  var parent = this._parent, childModel = parent.model(this._schema.options.hasMany || this._schema.options.habtm), setParent = this._schema.options.setParent, childPath = childModel.schema._findPathReferencing(parent.constructor.modelName);
  // You *need* a reference in the child `Document`
  if (!childPath)
    throw new Error('Parent model not referenced anywhere in the Child Schema');
  var safeConditions = {};
...
MongooseArray.prototype.populate = function (fields, callback) {
  ...
  var parent = this._parent, setParent = this._schema.options.setParent, model = parent.constructor, path = this._path;
  if(!setParent)
...
MongooseArray.prototype.remove = MongooseArray.prototype.delete = function (id, callback) {
  ...
  var self = this, parent = this._parent, setParent = this._schema.options.setParent, childModel = parent.model(relationship.ref);
...
MongooseArray.prototype.append = function (child, callback) {
  ...
  var relationship = this._getRelationship(), setParent = this._schema.options.setParent;
