...
HasAndBelongsToMany.prototype.build = function(objs){
  if (Array.isArray(objs)) {
    ...
    if (shouldSetChild.call(this)) {
      child[childPath.name].push(this._path._parent);
    }
...
HasAndBelongsToMany.prototype.create = function (objs, callback) {
  ...
  var createOne = function(doc, done){
    if (!validForCreate.bind(this)(doc))
  ...
  if(Array.isArray(objs)){
    ...
    objs.forEach(function(obj){
      createOne.bind(this)(obj, function(err, doc){
        if (err) return complete.bind(this)(err);
        docs.push(doc);
        --count || complete.bind(this)(null, docs);
      }.bind(this));
    }.bind(this));
  }
  else {
    createOne.bind(this)(objs, complete.bind(this));
  }
};
...
var shouldSetChild = function () { return !!this._path._schema.options.setChild; };
...
MongooseArray.prototype.build = function (objs) {
  return (new HasAndBelongsToMany(this)).build(objs);
};
