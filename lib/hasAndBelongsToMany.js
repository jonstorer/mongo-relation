...
function HasAndBelongsToMany (doc, options) {
  this._options = options || {};
...
var HasAndBelongsToManyMongooseArray;
function HasAndBelongsToManyMongooseArray () {
}
...
module.exports = function (schema, associationName, options) {
  ...
  var path = {};
  path[associationName] = new HasAndBelongsToManyMongooseArray[{
    type: ObjectId,
    index: true,
    ref: associationModelName
  }];
